  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 py-12 px-6">
      <div className="max-w-3xl mx-auto space-y-8 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
        <Link href="/" className="inline-flex items-center text-[#20C888] font-bold hover:brightness-110 transition-all gap-2 mb-4">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed font-medium">
          ...
          <p>
            By using this website and submitting your information for a property appraisal, you agree to these Terms of Service. These terms apply to the use of this landing page and the services provided by Ed Scanlan as a licensed real estate salesperson under Arizto.
          </p>
          ...
          <p>
            By submitting the form (either on our website or via a third-party platform like Facebook), you consent to Ed Scanlan (Arizto) contacting you via phone or email regarding your property appraisal and future real estate services. Your data will be handled in accordance with our <Link href="/privacy" className="text-[#20C888] underline hover:brightness-110">Privacy Policy</Link> and the New Zealand Privacy Act 2020.
          </p>
          ...
          <p>
            Requesting a property appraisal through this website or our advertisements places you under no obligation to list or sell your property with Ed Scanlan or Arizto. The appraisal is provided as a free, no-obligation service.
          </p>
