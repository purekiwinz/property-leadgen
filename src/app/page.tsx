        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
          {
            ...
            '@id': 'https://edscanlan.co.nz/#agent',
            name: 'Ed Scanlan — Professionals Hibiscus Coast',
            url: 'https://edscanlan.co.nz',
            telephone: '+64-21-814-578',
            email: 'ed.scanlan@meros.co.nz',
            image: 'https://edscanlan.co.nz/agent_transparent.webp',
            ...
            hasOfferCatalog: {
              ...
              itemListElement: [
                { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Free Market Appraisal', url: 'https://edscanlan.co.nz/#appraisal' } },
                { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Property Sales', url: 'https://edscanlan.co.nz/#recent-sales' } },
              ],
            },
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Person',
            '@id': 'https://edscanlan.co.nz/#ed-scanlan',
            name: agentName,
            jobTitle: 'Licensed Real Estate Salesperson',
            telephone: `+64-21-814-578`,
            email: 'ed.scanlan@meros.co.nz',
            image: 'https://edscanlan.co.nz/agent_transparent.webp',
            worksFor: { '@id': 'https://edscanlan.co.nz/#agent' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'WebSite',
            '@id': 'https://edscanlan.co.nz/#website',
            url: 'https://edscanlan.co.nz',
            ...
            publisher: { '@id': 'https://edscanlan.co.nz/#agent' },
            potentialAction: {
              '@type': 'SearchAction',
              target: 'https://edscanlan.co.nz/?suburb={suburb}',
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'WebPage',
            '@id': 'https://edscanlan.co.nz/#webpage',
            url: 'https://edscanlan.co.nz',
            name: 'Free Property Appraisal | Ed Scanlan — Hibiscus Coast Real Estate',
            isPartOf: { '@id': 'https://edscanlan.co.nz/#website' },
            about: { '@id': 'https://edscanlan.co.nz/#agent' },
            ...
            significantLink: [
              'https://edscanlan.co.nz/#appraisal',
              'https://edscanlan.co.nz/#recent-sales',
              'https://edscanlan.co.nz/#about',
            ],
          },
        ]) }}
      />
