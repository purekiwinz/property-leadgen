...
function renderFrontAd(suburb: Suburb): string {
  ...
  return `<div class="ad">
    ...
    <div class="col-content">
      ...
      <div class="logo-area">
        <svg aria-label="Professionals Hibiscus Coast" style="width:190px;height:48px;display:block"><use href="#prof-logo"/></svg>
      </div>
    </div>
    <div class="col-qr">
...
<head>
  ...
  <style>
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* ── FRONT: content col ── */
    .col-content { flex: 1; display: flex; flex-direction: column; justify-content: space-between; padding: 18px 14px 16px 18px; overflow: hidden; }
    .headline-block { display: flex; flex-direction: column; }
    .check-your { font-size: 10px; font-weight: 400; color: #fff; letter-spacing: 0.04em; line-height: 1.6; }
    .suburb-name { font-family: 'Source Serif 4', Georgia, serif; font-size: 40px; font-weight: 700; font-style: italic; color: #FF4753; letter-spacing: -0.01em; line-height: 1; white-space: nowrap; }
    .selling-price { font-size: 9px; font-weight: 700; color: #fff; line-height: 1.35; letter-spacing: 0.08em; text-transform: uppercase; margin-top: 4px; }
    .red-rule { width: 100%; height: 2px; background: #FF4753; flex-shrink: 0; }
