    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 py-12 px-6">
      <div className="max-w-3xl mx-auto space-y-8 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed font-medium">
          ...
          <p>
            We keep your information safe by storing it in secure cloud databases and only allowing authorized real estate personnel (Ed Scanlan and the Arizto team) to access it for the purposes of providing real estate services to you.
          </p>

          <p>
            You have the right to ask for a copy of any personal information we hold about you, and to ask for it to be corrected if you think it is wrong. If you&apos;d like to ask for a copy of your information, or to have it corrected, please contact us at <strong>ed.s@arizto.co.nz</strong>, or <strong>021 814 578</strong>.
          </p>
